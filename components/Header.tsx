      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16 sm:h-20">
          <div className="flex items-center space-x-3 group cursor-pointer transition-transform duration-300 hover:scale-105">
            ...
            <div>
              <h1 className="text-xl sm:text-2xl font-black text-slate-900 tracking-tighter leading-none italic uppercase">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="p-3 text-slate-600 hover:text-orange-500 transition-all duration-300 ease-out group flex flex-col items-center hover:bg-slate-50 rounded-2xl active:scale-95 hover:scale-105"
              title="Mis Pedidos"
            >
            ...
            <button
              onClick={onCartClick}
              className="relative p-3 text-slate-600 hover:text-orange-500 transition-all duration-300 ease-out group flex flex-col items-center hover:bg-slate-50 rounded-2xl active:scale-95 hover:scale-105"
              title="Mi Carrito"
            >
              <ShoppingCart className="w-6 h-6" />
              <span className="text-[10px] font-black uppercase hidden sm:block mt-1">Carrito</span>
              {cartCount > 0 && (
                <span className="absolute top-2 right-2 inline-flex items-center justify-center px-2 py-1 text-[10px] font-black leading-none text-white transform translate-x-1/2 -translate-y-1/2 bg-orange-600 rounded-full shadow-lg border-2 border-white animate-in zoom-in">
                  {cartCount}
                </span>
              )}
            </button>
